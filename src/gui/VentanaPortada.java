...
public class VentanaPortada extends JFrame {
	...
	public VentanaPortada() {
		...
		usuarioLabel.setIcon(getIconoUsuario(usuario));
	...
	private ImageIcon getIconoUsuario(Usuario usuario) {
		if (usuario instanceof Admin) {
			return Utils.loadImage("adminUser.png", 80, 80);
		} else if (usuario instanceof Cliente) {
			return Utils.loadImage("user.png", 80, 80);
		} else {
			return Utils.loadImage("noUser.png", 80, 80);
		}
	}

	public void refrescarUsuario() {
		usuarioLabel.setIcon(getIconoUsuario(main.getUsuario()));
	}
