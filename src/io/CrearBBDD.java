...
public class CrearBBDD {
	...
	public CrearBBDD() {
		...
		String sql = """
				...
				CREATE TABLE IF NOT EXISTS "ReviewPelicula" (
				    "id" INTEGER PRIMARY KEY AUTOINCREMENT,
				    "comentario" TEXT,
				    "rating" INTEGER NOT NULL,
				...
				CREATE TABLE IF NOT EXISTS "ReviewVideojuegos" (
				    "id" INTEGER PRIMARY KEY AUTOINCREMENT,
				    "comentario" TEXT,
				    "rating" INTEGER NOT NULL,
				...
				CREATE TABLE IF NOT EXISTS "ReservaPelicula" (
				    "id" INTEGER PRIMARY KEY AUTOINCREMENT,
				...
				CREATE TABLE IF NOT EXISTS "ReservaVideojuego" (
				    "id" INTEGER PRIMARY KEY AUTOINCREMENT,
				    "fecha_entrada" TEXT,
				    "dni_cliente" TEXT,
