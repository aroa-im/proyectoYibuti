...
public class Cliente extends Usuario {
    ...
    public Cliente(String dni, String nombre, String email, String contrasena, 
                   ArrayList<Producto> historial, ArrayList<Review> listaReviews,
                   int amonestaciones) {
    ...
    public Cliente(UsuarioDTO usuarioDTO) {
        ...
        // Cargar historial de productos alquilados desde la BD
        this.historial = main.getAlquilerDAO().getProductosAlquiladosByUsuario(usuarioDTO.getDni());
    ...
    public String toString() {
        return "Cliente [historial=" + historial + ", listaReviews=" + listaReviews + 
